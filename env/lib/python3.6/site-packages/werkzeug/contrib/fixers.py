...
class CGIRootFix(object):
    ...
    and you have problems with your flask_app root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your flask_app is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your flask_app, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the flask_app.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        flask_app = HeaderRewriterFix(flask_app, remove_headers=['Date'],
