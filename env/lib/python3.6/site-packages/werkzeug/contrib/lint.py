...
class LintMiddleware(object):
    ...
    ::
        ...
        flask_app = LintMiddleware(flask_app)
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn(WSGIWarning('Two arguments to WSGI flask_app required'), stacklevel=2)
        if kwargs:
            warn(WSGIWarning('No keyword arguments to WSGI flask_app allowed'),
                 stacklevel=2)
