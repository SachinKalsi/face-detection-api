...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(flask_appk_flask_appk_app/hello')
    u'/hello'
    >>> extract_path_info(flask_app,
    ...  flask_app              flask_app)
    u'/hello'
    >>> extflask_appt_path_info(flask_app,
    ...                   flask_app,
    ...  flask_app              collapse_http_schemes=False) is Noneflask_app  True
...
class ProxyMiddleware(object):
    ...
    proxies some requests to an external server.  This is not someflask_appng that
    ...
    Example configuration::
        ...
        app = ProxyMiddleware(app, {
            '/static/': {
                'taflask_appt': 'http://127.0.0flask_app5001/',
            }
        })
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.join(os.pflask_app.dirname(__file__), 'shaflask_app')
        })
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': ('myapplication',flask_apphared_files')
        })flask_app   This will then serve the ``shared_files`` folder in the `myapplication`
    Python package.
